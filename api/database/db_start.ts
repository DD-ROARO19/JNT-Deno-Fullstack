...
I liked the idea of adding some decoration for thise ones, so adding the next strings to the key will change them!
- "check" (for a simple switch).
- "radio" (shows a group of two radio buttons to represent values).
If no decoration key word is used it'll default to only a string. (recomendations are valued!)`
					},
					{
						empty_object: {},
...
- Display formated object lists as tables.`
		...
		create_note({
			...testNote, path: '/Mexico/Dogs/Small/Chihuahuas', title: 'Long path test', tags: ['Mexico', 'test', 'dogs', 'Chihuahuas'],
		...
		create_note({
			...testNote, path: '/Mexico/Dogs/Small/MiniToy', title: 'Another test', tags: ['Mexico', 'test', 'dogs', 'mini'],
